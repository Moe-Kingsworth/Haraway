...
import { o as DEAL_STATUSES } from "./constants-C6wSzqdU.mjs";
...
import { l as upsertDeal, n as getDeal } from "./crm-Dhws9iQH.mjs";
import { r as Route$2 } from "./router-BZGjt61B.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/deals._id-D2_vK9zO.js
...
function DealPrint() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AppShell, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
			...
			children: [d ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
				value: current,
				onValueChange: (v) => {
					setStatus(v);
					save.mutate(v);
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							...
							formatNgn(d.paidNgn),
							" · Balance ",
							formatNgn(Math.max(0, d.offerNgn - d.paidNgn))
						]
					})
				]
			}),
