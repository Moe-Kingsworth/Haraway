...
import { dateStr, num, resolveAccess, tsStr } from "./access";
...
export const getDashboard = createServerFn({ method: "GET" })
  ...
  .handler(async ({ context }) => {
    ...
    const collections = await sql<{ month: string; amount: unknown }>`
